...
### 1. **Seamless Table Booking**
   ...
   ![Booking a Table](reservations/static/images/readme/booking_page1.JPG)
   ![Booking a Table](reservations/static/images/readme/booking_page2.JPG)
   ![Booking a Table](reservations/static/images/readme/booking_page3.JPG)
   ![Booking a Table](reservations/static/images/readme/booking_success.JPG)
...
### 2. **Manage Reservations (Cancel/Edit)**
   ...
   ![Reservation](reservations/static/images/readme/reservations_page.JPG)
   ![Reservation](reservations/static/images/readme/reservations_page2.JPG)
   ![Cancel/Edit Reservation](reservations/static/images/readme/cancel_booking.JPG)
   ![Cancel/Edit Reservation](reservations/static/images/readme/edit_booking.JPG)
...
### 3. **Secure User Authentication (Login)**
   ...
   ![Login](reservations/static/images/readme/login.JPG)
...
### 4. **Easy Account Creation (Signup)**
   ...
   ![Signup](reservations/static/images/readme/signup.JPG)
...
### 7. **Digital Menu**
   ...
   ![Menu](reservations/static/images/readme/menu.JPG)
...
### 8. **About Us Page**
   ...
   ![About](reservations/static/images/about.JPG)
...
### 9. **Contact Page**
   ...
   ![Contact](reservations/static/images/readme/contact.JPG)
